...
PARSER.add_argument('--warm_start', default=False, action="store_true", help='Warm-start actor, critics and '
                                                                             'value function.')
PARSER.add_argument('--tolerance', default=0, help="return improvement +\- for moving to next curriculum stage.")
PARSER.add_argument('--n_prev_returns', default=1, help='N previous returns to use to determine improvement.'
                                                                             'value function.')
