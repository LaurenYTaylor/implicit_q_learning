...
if __name__ == "__main__":
    ...
    folder_stub = "all_var_at251023"
    folder_stub_noat = "all_var_noat251023"
    env = ""
    ...
    for t in tolerance_options:
        ...
        plt.tight_layout()
        #plt.savefig(f"results/{folder_stub}/{t}_agent_type_compare_atonly.svg",
        #            format="svg", dpi=300, bbox_inches='tight')
        #plt.savefig(f"results/{folder_stub_noat}/{t}_agent_type_compare.svg",
        #            format="svg", dpi=300, bbox_inches='tight')
        plt.show()
        plt.close()
